...
<body>
	...
	<br>
	<br>
	<h2 align="center">Instruction for ${sessionScope.exam} Assesment :</h2>
	<div style="position: absolute; left: 500px; top: 170px">
		<ul style="list-style-type: disc">
			<li>Assesment contains ${sessionScope.totalNumberOfQuizQuestions}
				Multiple Choice Questions</li>
			<li>Total time for the Assesment is ${sessionScope.quizDuration}
				Minutes</li>
